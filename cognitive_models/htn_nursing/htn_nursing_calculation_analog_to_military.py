...
#Non-Dynamic
def htn_nursing_calculation_analog_to_military_problem():
    hour = randint(1, 12) 
    minutes = [15, 30, 45, 40, 50, 20, 10]
    minute = minutes[randint(0, 6)]
    ...
    prob = [standard_time, hour, minute, vals[am_pm], 0, standard_time]
    return prob
...
def htn_nursing_calculation_analog_to_military_kc_mapping():
...
def htn_nursing_calculation_analog_to_military_studymaterial():
...
def htn_nursing_calculation_analog_to_military_intermediate_hints():
    hints = {
...
htn_loaded_models.register(HTNCognitiveModel('htn_nursing_military',    
                                             'htn_nursing_calculation_analog_to_military',
                                             Domain,
                                             Task(head=('solve', 'equation'), primitive=False),
                                            htn_nursing_calculation_analog_to_military_problem,
                                            htn_nursing_calculation_analog_to_military_kc_mapping(),
                                            htn_nursing_calculation_analog_to_military_intermediate_hints(),
                                            htn_nursing_calculation_analog_to_military_studymaterial()))