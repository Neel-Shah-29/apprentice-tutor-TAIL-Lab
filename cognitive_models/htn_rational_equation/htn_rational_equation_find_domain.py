...
def htn_rational_equation_find_domain_intermediate_hints():
    hints = {
        ...
        "domain_left":["The domain of a rational function is all real numbers except those that make the rational expression undefined.",
                       "Write down the result"],
        "domain_right":["The domain of a rational function is all real numbers except those that make the rational expression undefined.",
                        "Write down the result"],
