...
def htn_quadratic_equations_solve_using_square_root_property_intermediate_hints():
    hints = {
            'coeff0_to_rhs': ["Move the constant term to the right hand side of the "
                            "equation."],
            'update_coeff0_on_rhs': ["Simplify the right hand side."],
            'coeff2_to_rhs': ["Move the coefficient of x^2 to the right hand."],
            'update_coeff2_on_rhs': ["Move the coefficient of x^2 to the right hand."],
