...
def exponential_equations_fractional_exponents_common_base_model():
    net = ReteNetwork()

    @Production(Fact(field="initial_problem", value=V('init_value')) &
                Fact(field="fractional_exponents", disabled=False))
    def fractional_exponents(init_value):
        ...
        hint = latex(equation)
        return [Fact(selection="fractional_exponents", action="input change", input=answer, hint=hint)]
    ...
    net.add_production(fractional_exponents)
...
def exponential_equations_fractional_exponents_common_base_kc_mapping():
    kcs = {
...
def exponential_equations_fractional_exponents_common_base_intermediate_hints():
    hints = {
...
def exponential_equations_fractional_exponents_common_base_studymaterial():
...
loaded_models.register(CognitiveModel("exponential_equations",
                                      "exponential_equations_fractional_exponents_common_base",
                                      exponential_equations_fractional_exponents_common_base_model,
                                      exponential_equations_fractional_exponents_common_base_problem,
                                      exponential_equations_fractional_exponents_common_base_kc_mapping(),
                                      exponential_equations_fractional_exponents_common_base_intermediate_hints(),
                                      exponential_equations_fractional_exponents_common_base_studymaterial()))